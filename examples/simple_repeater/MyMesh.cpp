...
// Flood pre-dispatch veto invoked by the base Mesh (see Mesh.h): returning true
// means the packet is NOT processed at all (no local delivery, no retransmission).
